...
class P3Parser:
    ...
    def parse_p3_information(primer_pair_set, p3output):
        ...
        for i in range(num_primers):
            ...
            fwd.self = content.getfloat(
                "root", "PRIMER_LEFT_" + str(i) + "_SELF_END_TH"
            )
            ...
            rev.any = content.getfloat(
                "root", "PRIMER_RIGHT_" + str(i) + "_SELF_ANY_TH"
            )
            rev.self = content.getfloat(
                "root", "PRIMER_RIGHT_" + str(i) + "_SELF_END_TH"
            )
        ...
        with open(config_path) as fp:
            ...
            for line in fp:
                ...
                if line.split("=")[0] == "PRIMER_PRODUCT_SIZE_RANGE":
                    products = list(
                        map(int, re.split(r"\W+", line.split("=")[1].strip()))
                    )
